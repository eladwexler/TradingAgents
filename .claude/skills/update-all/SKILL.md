...
> **Scope:** `/update-all` refreshes **data only**. It does **not** run fresh per-ticker
...
- Does not auto-**resolve** forecasts or run `/ai-cycle-watch` — offer those as follow-ups.
